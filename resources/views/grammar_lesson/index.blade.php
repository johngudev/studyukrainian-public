...
<div class="container">
    ...
    <div class="modern-panel px-0 py-5 text-graphite-black">
        <h1 class="px-5">Grammar Lessons </h1>
        <div class="px-5 text-light-gray" >These grammar lessons are designed to help you to speak Ukrainian correctly and with confidence.
        </div>
